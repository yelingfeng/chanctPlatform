<template>
    <div class="yq-switch">
        ...
        <div class="yq-switch__lcs" :style="swicthStyle" @click="radioChange">
            ...
            <div class="yq-switch__text yq-switch__on" v-show="value">{{option.onText}}</div>
            <div class="yq-switch__text yq-switch__off" v-show="value">{{option.offText}}</div>
        </div>
    </div>
</template>
<script>
    export default {
        ...
        methods: {
            radioChange () {
                ...
                if (this.option.click && _.isFunction(this.option.click)) {
